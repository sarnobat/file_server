 ...
 */
public class NanoHTTPDModified {
	// ==================================================
	// API parts
	// ==================================================
	...
	public NanoHTTPDModified (int port) throws IOException {
		this(port, new File(".").getAbsoluteFile());
	}

	public NanoHTTPDModified (SocketAddress inetAddress) throws IOException {
		this(new File(".").getAbsoluteFile(), inetAddress);
	}

	public NanoHTTPDModified (int port, File wwwroot) throws IOException {
	 ...
	 */
	public NanoHTTPDModified (/*int port, */File wwwroot, SocketAddress inetAddress) throws IOException {
		//        myTcpPort = port;
	...
	public NanoHTTPDModified(String string) throws IOException {
	...
	public static void main (String[] args) {
		...
		// Defaults
		int port = 80;
		File wwwroot = new File("/sarnobat.garagebandbroken/trash/misc_sync_master/wwe").getAbsoluteFile();  
		...
		try {
			new NanoHTTPDModified(port, wwwroot);
		} catch (IOException ioe) {
	...
	private String listDirectoryAsHtml(String uri, File f, String[] files) {
	...
	private String showfileSize2(String msg, File curFile) {
		if (curFile.isFile()) {
